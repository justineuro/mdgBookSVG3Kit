...
Wait for a **few** minutes, i.e., until one gets the bash prompt again.  The compiled book in PDF format (`mdgBookSVG3v1.pdf`), among other things, should be located in the `res` folder (subdirectory).  

## For the Impatient
To download and examine an example of a book (`mdgBookSVG3v1.pdf`) that was generated in a similar manner, simply right-click (then "Save Link As ...") on the following image:

[![Front Cover](https://github.com/justineuro/mdgBookSVG3Kit/raw/main/mdgBookSVG3v1-tit.jpg)](https://raw.githubusercontent.com/justineuro/mdgBookSVG3Kit/main/mdgBookSVG3v1.pdf)

(**Note**: To enable the MIDI audio links in the book, one should download [mdgBookSVG3v1_1-midi.zip](https://github.com/justineuro/mdgBookSVG3Kit/raw/main/mdgBookSVG3v1_1-midi.zip) and unzip in the same directory in one's computer that contains the book, i.e., the book and midi files have to be in the same directory).
...
- `mdgBookSVG3v1.tex` - (main latex file) see lines 36-46; also, one may have to occassionally change the \\topmargin and \\textheight values on lines 266 and 267 of this file to ensure that each audio MIDI file will be on the same page as the corresponding musical score; these values affect the pages containing the 28 sample minuets and are different from the global values that appear on lines 30 and 31 near the top part of the file
- `mdgBookSVG3v1-cover.tex`- makes the cover of the book; see lines 36-46 of `mdgBookSVG3v1.tex` for default values
...
Also, line 34 of the `HOWTO` is set by default so that each new book created contains 28 minuet-trios.  One may wish to change this number, as desired, to some other counting number.  This has to be done **before** issuing the `bash HOWTO` command within the `mdgBookSVG3Kit-main` directory.
...
- [mdgBookSVG4Kit](https://justineuro.github.io/mdgBookSVG4Kit) - One-Command Kit for Creating MDG Minuet-Trios Collection Book, the minuet-trios are generated based on the rules given in [*Table pour composer des Minuets et des Trios &agrave; la infinie*](http://imslp.org/wiki/Table_pour_composer_des_Minuets_et_des_Trios_%C3%A0_la_infinie_(Stadler,_Maximilian)) (also known as *Tabelle welcher aus man unzählige Menuetten und Trio für das Klavier herauswürfeln kann* or *Gioco Filarmonico o sia maniera facile per comporre un infinito numero di menuetti e trio, anche senza sapere il contrapunto*) 
...
<p xmlns:dct="http://purl.org/dc/terms/" xmlns:vcard="http://www.w3.org/2001/vcard-rdf/3.0#">
  ...
  <span property="dct:title"><a href="https://github.com/justineuro/mdgBookSVG3Kit">mdgBookSVG3Kit</a></span>.
This work is published from:
<span property="vcard:Country" datatype="dct:ISO3166"
      content="PH" about="https://github.com/justineuro/mdgBookSVG3Kit">
  Philippines</span>.
</p>
